...
project needs the loader script (step 3) — that's the one judgment this skill
keeps.
...
1. Confirm the base is in place. If this fails, stop and run the
...
Use the `shipeasy-i18n-extract` skill to wrap hardcoded copy and push keys, or
the `shipeasy-i18n` skill for guided edits.
