 ...
 */
export const createGateTemplate = <ThrowOnError extends boolean = false>(options: Options<CreateGateTemplateData, ThrowOnError>): RequestResult<CreateGateTemplateResponses, CreateGateTemplateErrors, ThrowOnError> => (options.client ?? client).post<CreateGateTemplateResponses, CreateGateTemplateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/admin/gates/templates',
    ...options,
    headers: {
 ...
 */
export const deleteGateTemplate = <ThrowOnError extends boolean = false>(options: Options<DeleteGateTemplateData, ThrowOnError>): RequestResult<DeleteGateTemplateResponses, DeleteGateTemplateErrors, ThrowOnError> => (options.client ?? client).delete<DeleteGateTemplateResponses, DeleteGateTemplateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getGateTemplate = <ThrowOnError extends boolean = false>(options: Options<GetGateTemplateData, ThrowOnError>): RequestResult<GetGateTemplateResponses, GetGateTemplateErrors, ThrowOnError> => (options.client ?? client).get<GetGateTemplateResponses, GetGateTemplateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/admin/gates/templates/{id}',
    ...options
});
 ...
 */
export const updateGateTemplate = <ThrowOnError extends boolean = false>(options: Options<UpdateGateTemplateData, ThrowOnError>): RequestResult<UpdateGateTemplateResponses, UpdateGateTemplateErrors, ThrowOnError> => (options.client ?? client).patch<UpdateGateTemplateResponses, UpdateGateTemplateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/admin/gates/templates/{id}',
    ...options,
    headers: {
 ...
 */
export const listOpsComments = <ThrowOnError extends boolean = false>(options: Options<ListOpsCommentsData, ThrowOnError>): RequestResult<ListOpsCommentsResponses, ListOpsCommentsErrors, ThrowOnError> => (options.client ?? client).get<ListOpsCommentsResponses, ListOpsCommentsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const createOpsComment = <ThrowOnError extends boolean = false>(options: Options<CreateOpsCommentData, ThrowOnError>): RequestResult<CreateOpsCommentResponses, CreateOpsCommentErrors, ThrowOnError> => (options.client ?? client).post<CreateOpsCommentResponses, CreateOpsCommentErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/admin/ops/{handle}/comments',
    ...options,
    headers: {
 ...
 *
 * The caller's in-app notification feed — the same list the dashboard bell
 * renders — plus the unread count. Returns project-wide broadcasts and
 * notifications addressed to the caller (mentions), newest first (max 30);
 * events the project muted for the in-app channel are omitted.
 *
 * **Use case:** Render the bell — list the latest notifications and badge
 * the unread count.
 */
export const listNotificationFeed = <ThrowOnError extends boolean = false>(options?: Options<ListNotificationFeedData, ThrowOnError>): RequestResult<ListNotificationFeedResponses, ListNotificationFeedErrors, ThrowOnError> => (options?.client ?? client).get<ListNotificationFeedResponses, ListNotificationFeedErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 *
 * Mark one notification read (`{ "id": "…" }`) or the caller's whole feed
 * read (empty body `{}`). Idempotent.
 *
 * **Use case:** Clear the bell badge after the user opens the feed.
 */
 ...
 */
export const getProjectErrorSeries = <ThrowOnError extends boolean = false>(options: Options<GetProjectErrorSeriesData, ThrowOnError>): RequestResult<GetProjectErrorSeriesResponses, GetProjectErrorSeriesErrors, ThrowOnError> => (options.client ?? client).post<GetProjectErrorSeriesResponses, GetProjectErrorSeriesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
